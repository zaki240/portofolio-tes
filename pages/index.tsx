      ...
      <main className=' bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-700'>
        <section className=' min-h-screen'>
          <nav className='py-10 mb-12 flex justify-between'>
            <h1 className='text-xl font-burtons'>zzz</h1>
          ...
          <div className='text-center p-10 '>
            <h2 className='text-5xl py-2 text-teal-600 font-medium md:text-6xl dark:text-white'>Zaki</h2>
            <h3 className='text-2xl py-2 md:text-3xl dark:text-white'>Developer and Software enginer</h3>
            <p className="text-md py-5 leading-8 text-gray-800 dark:text-white max-w-lg mx-auto md:text-xl">
        ...
        <section>
          ...
          <div className='lg:flex gap-10'>
            <div className='text-center  shadow-lg p-10 rounded-xl my-10 dark:bg-white'>
              <Image src={design} className="inline-block" width={100} height={100}/>
            ...
            <div className='text-center  shadow-lg p-10 rounded-xl my-10 dark:bg-white'>
              <Image src={consulting} className="inline-block" width={100} height={100}/>
              <h3 className=' text-lg font-medium pt-8 pb-2'>Beatiful Design</h3>
              <p className='py-2'>Creating elegant designs suited for your needs following core
                design theory.</p>
              <h4 className="py-4 text-teal-600">Design Tools I Use</h4>
            ...
            <div className='text-center  shadow-lg p-10 rounded-xl my-10 dark:bg-white'>
              <Image src={code} className="inline-block" width={100} height={100}/>
              <h3 className=' text-lg font-medium pt-8 pb-2'>Beatiful Design</h3>
              <p className='py-2'>Creating elegant designs suited for your needs following core
                design theory.</p>
              <h4 className="py-4 text-teal-600">Design Tools I Use</h4>
